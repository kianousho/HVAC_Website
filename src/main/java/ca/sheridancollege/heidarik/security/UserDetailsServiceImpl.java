package ca.sheridancollege.heidarik.security;
...
ca.sheridancollege.heidarik.beans.User user = da.findUserAccount(username);
...
//GrantedAuthority
System.out.println("Roles for user " + user.getEmail() + ": " + roleNameList);
